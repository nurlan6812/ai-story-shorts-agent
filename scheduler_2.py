...
사용법:
    python scheduler_2.py           # 데몬 시작 (정시 30분 결과 점검)
    python scheduler_2.py --once    # 현재 시점 기준 1회 점검

스케줄:
    - 매시 30분 실행
    - 06:30 슬롯 -> 07:30/08:30/09:30 점검
    - 11:30 슬롯 -> 12:30/13:30/14:30 점검
    - 18:30 슬롯 -> 19:30/20:30/21:30 점검
"""
...
def main():
    ...
    log.info("  - 11:30 슬롯: 12:30/13:30/14:30")
